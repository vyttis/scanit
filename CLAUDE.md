# CLAUDE.md — scanit.lt Project Bible

## What We Are Building

**scanit.lt** — An external attack surface scanning platform for Lithuanian organizations that must comply with the Kibernetinio saugumo įstatymas (KSĮ / Lithuanian Cybersecurity Law, implementing NIS2/TIS2).
...
| Layer | URL | Built where |
|---|---|---|
| Landing page | scanit.lt | Lovable.dev — separate project, not in this repo |
| Platform | platform.scanit.lt | This repo — Next.js on Vercel |
| API / scan engine | platform.scanit.lt/api/* | Next.js API routes + server-side Python |

**Important:** This repository covers **platform.scanit.lt** only. The landing page on scanit.lt is a separate Lovable.dev project — never part of this codebase. Do not build marketing pages, pricing pages, or landing content here.

CORS must explicitly allow only `platform.scanit.lt` — never wildcard.
...
# App
NEXTAUTH_SECRET=
NEXT_PUBLIC_APP_URL=https://platform.scanit.lt
```
